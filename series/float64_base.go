...
func (s SeriesFloat64) GetContext() *gandalff.Context {
	return s.ctx
}
...
func (s SeriesFloat64) Type() meta.BaseType {
	return meta.Float64Type
}

// Return the type and cardinality of the series.
func (s SeriesFloat64) TypeCard() meta.BaseTypeCard {
...
func (s SeriesFloat64) IsSorted() gandalff.SeriesSortOrder {
	return s.sorted
}
...
func (s SeriesFloat64) getData() []float64 {
	return s.data
}
...
func (s SeriesFloat64) Map(f gandalff.MapFunc) Series {
	if len(s.data) == 0 {
		return s
	}
...
// Apply the given function to each element of the series.
func (s SeriesFloat64) MapNull(f gandalff.MapFuncNull) Series {
	if len(s.data) == 0 {
		return s
	}
